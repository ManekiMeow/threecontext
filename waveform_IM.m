...
%% 组成脉冲序列
space(1:N_signal-N_pulse*P_wave)=1;
waveform = [Body; space'];  
...
b=num2str(j);
csvwrite(['C:\Users\HefeiLaptop\Desktop\tek_control\2022_6_10更新\tek_control - 副本\tek_control - 副本\tek_control - 副本\waveform1\waveform_im' b '.csv'],waveform);
pause(0.1);
end